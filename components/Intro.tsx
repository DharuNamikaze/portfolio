...
const Intro = () => {
    return (
        <section className='flex flex-col justify-center text-center items-center min-h-screen sm:px-10 '>
            ...
            <span className='block text-sm sm:px-10 px-4 py-4'>Hi, I&apos;m Bro currently pursuing Artificial Intelligence and Data Science at KIT-CBE,  diving deep into solving computational problems</span>
