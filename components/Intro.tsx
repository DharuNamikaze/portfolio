        ...
        <section className='flex flex-col justify-center text-center items-center min-h-screen sm:px-10 '>
            ...
            <div className='flex items-center gap-2'>
                <Link aria-label='My Resume' href="/DharunR_resume.pdf" target='_blank' className=''>
                    <button title='Resume' type='button' className="text-lg p-2 m-1 rounded-md border dark:border-white dark:bg-white dark:text-black border-white bg-black text-white dark:hover:bg-slate-300  hover:bg-zinc-700 transition duration-300">
                        Resume
                    </button>
                </Link>
            </div>
