    ...
    return (
        <section className='flex flex-col justify-center text-center items-center min-h-screen sm:px-10 '>
            ...
            <Link href="/DharunR_resume.pdf" target='_blank' className=''>
                <button className="text-lg mt-2 px-4 py-2 rounded-md border dark:border-white dark:bg-white dark:text-black border-white bg-black text-white dark:hover:bg-slate-300  hover:bg-zinc-700 transition duration-300">
                    Resume
                </button>
            </Link>
        </section>
